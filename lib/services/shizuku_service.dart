...
class ShizukuService {
  ...
  /// Deep System Introspection: Optimize Battery (Force Doze Mode)
  Future<String> optimizeBattery() async {
    return runCommand('dumpsys deviceidle force-idle');
  }

  /// Deep System Introspection: Clear RAM (Drop Caches)
  Future<String> clearRam() async {
    // Note: requires very high privileges, Shizuku running as root (Rish) usually supports this
    return runCommand('sync && echo 3 > /proc/sys/vm/drop_caches');
  }

  /// Deep System Introspection: Get System Memory Profile
